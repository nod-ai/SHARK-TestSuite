...
def dim_param_constructor(dim_param_dict):
    class AzureWithDimParams(AzureDownloadableModel):
        def __init__(self, *args, **kwargs):
            ...
            if self.name == "migraphx_sd__unet__model" or self.name == "migraphx_sdxl__unet__model":
                print("here")
                ...
                self.sess_options.add_session_config_entry("use_device_allocator_for_initializers", "1")
