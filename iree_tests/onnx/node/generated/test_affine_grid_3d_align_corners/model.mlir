module {
  func.func public @test_affine_grid_3d_align_corners(%arg0: !torch.vtensor<[2,3,4],f32>, %arg1: !torch.vtensor<[5],si64>) -> !torch.vtensor<[2,4,5,6,3],f32> attributes {torch.onnx_meta.ir_version = 9 : si64, torch.onnx_meta.opset_version = 20 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    %0 = call @"('AffineGrid', '', 20, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 4\0A    }\0A  }\0A}\0A, tensor_type {\0A  elem_type: 7\0A  shape {\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 4\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A    dim {\0A      dim_value: 6\0A    }\0A    dim {\0A      dim_value: 3\0A    }\0A  }\0A}\0A], [name: \22align_corners\22\0Ai: 1\0Atype: INT\0A])"(%arg0, %arg1) : (!torch.vtensor<[2,3,4],f32>, !torch.vtensor<[5],si64>) -> !torch.vtensor<[2,4,5,6,3],f32>
    return %0 : !torch.vtensor<[2,4,5,6,3],f32>
  }
  func.func private @"('AffineGrid', '', 20, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 4\0A    }\0A  }\0A}\0A, tensor_type {\0A  elem_type: 7\0A  shape {\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 4\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A    dim {\0A      dim_value: 6\0A    }\0A    dim {\0A      dim_value: 3\0A    }\0A  }\0A}\0A], [name: \22align_corners\22\0Ai: 1\0Atype: INT\0A])"(%arg0: !torch.vtensor<[2,3,4],f32>, %arg1: !torch.vtensor<[5],si64>) -> !torch.vtensor<[2,4,5,6,3],f32> attributes {torch.onnx_meta.ir_version = 9 : si64, torch.onnx_meta.opset_version = 20 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
