module {
  func.func public @test_shrink_hard_expanded_ver18(%arg0: !torch.vtensor<[5],f32>) -> !torch.vtensor<[5],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 18 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    ...
    %2 = torch.operator "onnx.Constant"() {torch.onnx.value_float = 0.000000e+00 : f32} : () -> !torch.vtensor<[],f32> 
