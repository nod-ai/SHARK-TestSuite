module {
  func.func @test_deform_conv_with_multiple_offset_groups(%arg0: !torch.vtensor<[1,2,3,3],f32>, %arg1: !torch.vtensor<[1,2,2,2],f32>, %arg2: !torch.vtensor<[1,16,2,2],f32>) -> !torch.vtensor<[1,1,2,2],f32> attributes {torch.onnx_meta.ir_version = 10 : si64, torch.onnx_meta.opset_version = 22 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
