module {
  func.func public @test_dynamicquantizelinear_max_adjusted(%arg0: !torch.vtensor<[6],f32>) -> (!torch.vtensor<[6],ui8>, !torch.vtensor<[],f32>, !torch.vtensor<[],ui8>) attributes {torch.onnx_meta.ir_version = 6 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    %0:3 = call @"('DynamicQuantizeLinear', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 6\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 2\0A  shape {\0A    dim {\0A      dim_value: 6\0A    }\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 2\0A  shape {\0A  }\0A}\0A], [])"(%arg0) : (!torch.vtensor<[6],f32>) -> (!torch.vtensor<[6],ui8>, !torch.vtensor<[],f32>, !torch.vtensor<[],ui8>)
    return %0#0, %0#1, %0#2 : !torch.vtensor<[6],ui8>, !torch.vtensor<[],f32>, !torch.vtensor<[],ui8>
  }
  func.func private @"('DynamicQuantizeLinear', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 6\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 2\0A  shape {\0A    dim {\0A      dim_value: 6\0A    }\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 2\0A  shape {\0A  }\0A}\0A], [])"(%arg0: !torch.vtensor<[6],f32>) -> (!torch.vtensor<[6],ui8>, !torch.vtensor<[],f32>, !torch.vtensor<[],ui8>) attributes {torch.onnx_meta.ir_version = 6 : si64, torch.onnx_meta.opset_version = 11 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
