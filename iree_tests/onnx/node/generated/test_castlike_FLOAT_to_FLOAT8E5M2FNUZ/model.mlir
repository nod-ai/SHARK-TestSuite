module {
  func.func public @test_castlike_FLOAT_to_FLOAT8E5M2FNUZ(%arg0: !torch.vtensor<[3,4],f32>, %arg1: !torch.vtensor<[1],f8E5M2FNUZ>) -> !torch.vtensor<[3,4],f8E5M2FNUZ> attributes {torch.onnx_meta.ir_version = 10 : si64, torch.onnx_meta.opset_version = 21 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
