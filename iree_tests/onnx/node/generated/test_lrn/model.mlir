module {
  func.func @test_lrn(%arg0: !torch.vtensor<[5,5,5,5],f32>) -> !torch.vtensor<[5,5,5,5],f32> attributes {torch.onnx_meta.ir_version = 7 : si64, torch.onnx_meta.opset_version = 13 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
