module {
  func.func public @test_blackmanwindow(%arg0: !torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    %0 = call @"('BlackmanWindow', '', 17, [tensor_type {\0A  elem_type: 6\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 10\0A    }\0A  }\0A}\0A], [])"(%arg0) : (!torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32>
    return %0 : !torch.vtensor<[10],f32>
  }
  func.func private @"('BlackmanWindow', '', 17, [tensor_type {\0A  elem_type: 6\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 10\0A    }\0A  }\0A}\0A], [])"(%arg0: !torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    ...
    %9 = torch.operator "onnx.Constant"() {torch.onnx.value_int = 1 : si64} : () -> !torch.vtensor<[],si64> 
