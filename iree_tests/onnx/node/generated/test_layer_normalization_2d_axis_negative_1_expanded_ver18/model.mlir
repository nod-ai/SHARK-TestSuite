module {
  func.func public @test_layer_normalization_2d_axis_negative_1_expanded_ver18(%arg0: !torch.vtensor<[3,4],f32>, %arg1: !torch.vtensor<[4],f32>, %arg2: !torch.vtensor<[4],f32>) -> (!torch.vtensor<[3,4],f32>, !torch.vtensor<[3,1],f32>, !torch.vtensor<[3,1],f32>) attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 18 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    ...
    %29 = torch.operator "onnx.Reshape"(%13, %9) : (!torch.vtensor<[3,1],f32>, !torch.vtensor<[?],si64>) -> !torch.vtensor<[3,1],f32> 
    %30 = torch.operator "onnx.Reshape"(%28, %9) : (!torch.vtensor<[3,1],f32>, !torch.vtensor<[?],si64>) -> !torch.vtensor<[3,1],f32> 
