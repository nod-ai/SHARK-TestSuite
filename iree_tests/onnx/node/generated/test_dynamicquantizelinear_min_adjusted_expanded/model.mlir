module {
  func.func public @test_dynamicquantizelinear_min_adjusted_expanded(%arg0: !torch.vtensor<[3,4],f32>) -> (!torch.vtensor<[3,4],ui8>, !torch.vtensor<[],f32>, !torch.vtensor<[],ui8>) attributes {torch.onnx_meta.ir_version = 6 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    ...
    %10 = call @"('Clip', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A], input: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Initial_ZeroPoint_FP\22\0Ainput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Q_Min\22\0Ainput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Q_Max\22\0Aoutput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Clipped_ZeroPoint_FP\22\0Aop_type: \22Clip\22\0Adomain: \22\22\0A)"(%9, %0, %1) : (!torch.vtensor<[],f32>, !torch.vtensor<[],f32>, !torch.vtensor<[],f32>) -> !torch.vtensor<[],f32>
  ...
  func.func private @"('Clip', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A, tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A  }\0A}\0A], input: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Initial_ZeroPoint_FP\22\0Ainput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Q_Min\22\0Ainput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Q_Max\22\0Aoutput: \22DynamicQuantizeLinear_test_dynamicquantizelinear_min_adjusted_expanded_function_Clipped_ZeroPoint_FP\22\0Aop_type: \22Clip\22\0Adomain: \22\22\0A)"(%arg0: !torch.vtensor<[],f32>, %arg1: !torch.vtensor<[],f32>, %arg2: !torch.vtensor<[],f32>) -> !torch.vtensor<[],f32> attributes {torch.onnx_meta.ir_version = 7 : si64, torch.onnx_meta.opset_version = 13 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
