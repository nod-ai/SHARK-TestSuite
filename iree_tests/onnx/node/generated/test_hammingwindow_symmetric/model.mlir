module {
  func.func public @test_hammingwindow_symmetric(%arg0: !torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    %0 = call @"('HammingWindow', '', 17, [tensor_type {\0A  elem_type: 6\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 10\0A    }\0A  }\0A}\0A], [name: \22periodic\22\0Ai: 0\0Atype: INT\0A])"(%arg0) : (!torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32>
    return %0 : !torch.vtensor<[10],f32>
  }
  func.func private @"('HammingWindow', '', 17, [tensor_type {\0A  elem_type: 6\0A  shape {\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 10\0A    }\0A  }\0A}\0A], [name: \22periodic\22\0Ai: 0\0Atype: INT\0A])"(%arg0: !torch.vtensor<[],si32>) -> !torch.vtensor<[10],f32> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
    %0 = torch.operator "onnx.Constant"() {torch.onnx.value = dense<0.543478251> : tensor<f32>} : () -> !torch.vtensor<[],f32> 
    %1 = torch.operator "onnx.Constant"() {torch.onnx.value = dense<0.456521749> : tensor<f32>} : () -> !torch.vtensor<[],f32> 
