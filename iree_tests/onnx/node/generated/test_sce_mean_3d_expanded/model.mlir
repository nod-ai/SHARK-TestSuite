module {
  func.func public @test_sce_mean_3d_expanded(%arg0: !torch.vtensor<[3,5,2],f32>, %arg1: !torch.vtensor<[3,2],si64>) -> !torch.vtensor<[],f32> attributes {torch.onnx_meta.ir_version = 7 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "backend-test", torch.onnx_meta.producer_version = ""} {
    ...
    %3 = call @"('LogSoftmax', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], input: \22SoftmaxCrossEntropyLoss_test_sce_mean_3d_expanded_function_X_NDC\22\0Aoutput: \22SoftmaxCrossEntropyLoss_test_sce_mean_3d_expanded_function_X_LogSM\22\0Aop_type: \22LogSoftmax\22\0Aattribute {\0A  name: \22axis\22\0A  i: 2\0A  type: INT\0A}\0Adomain: \22\22\0A)"(%2) : (!torch.vtensor<[3,2,5],f32>) -> !torch.vtensor<[3,2,5],f32>
  ...
  func.func private @"('LogSoftmax', '', 17, [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], [tensor_type {\0A  elem_type: 1\0A  shape {\0A    dim {\0A      dim_value: 3\0A    }\0A    dim {\0A      dim_value: 2\0A    }\0A    dim {\0A      dim_value: 5\0A    }\0A  }\0A}\0A], input: \22SoftmaxCrossEntropyLoss_test_sce_mean_3d_expanded_function_X_NDC\22\0Aoutput: \22SoftmaxCrossEntropyLoss_test_sce_mean_3d_expanded_function_X_LogSM\22\0Aop_type: \22LogSoftmax\22\0Aattribute {\0A  name: \22axis\22\0A  i: 2\0A  type: INT\0A}\0Adomain: \22\22\0A)"(%arg0: !torch.vtensor<[3,2,5],f32>) -> !torch.vtensor<[3,2,5],f32> attributes {torch.onnx_meta.ir_version = 7 : si64, torch.onnx_meta.opset_version = 13 : si64, torch.onnx_meta.producer_name = "", torch.onnx_meta.producer_version = ""} {
    %none = torch.constant.none
