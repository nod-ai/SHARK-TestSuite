...
def test_sdxl_rocm_benchmark(goldentime_rocm_e2e, goldentime_rocm_unet, 
    ...
    check.less_equal(benchmark_mean_time, goldentime_rocm_e2e, "SDXL e2e benchmark time should not regress")
    ...
    benchmark_mean_time = job_summary_process(ret_value, output)
    check.less_equal(benchmark_mean_time, goldentime_rocm_unet, "SDXL unet benchmark time should not regress")
    ...
    benchmark_mean_time = job_summary_process(ret_value, output)
    check.less_equal(benchmark_mean_time, goldentime_rocm_clip, "SDXL prompt encoder benchmark time should not regress")
    ...
    benchmark_mean_time = job_summary_process(ret_value, output)
    check.less_equal(benchmark_mean_time, goldentime_rocm_vae, "SDXL vae decode benchmark time should not regress")
